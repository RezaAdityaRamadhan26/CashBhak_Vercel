    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="hidden lg:flex bg-[var(--primary-custom)] flex-col justify-center items-center p-8">
        <div className="text-left mb-6">
          ...
          <h3 className="text-base xl:text-lg text-white">Continue To manage your business</h3>
        </div>
        <img
          src="/images/finance.png"
          alt="Finance Illustration"
          className="h-[300px] w-[300px] xl:h-[500px] xl:w-[500px] object-cover dark:brightness-[0.2] dark:grayscale" />
      </div>
    </div>
  );
}
